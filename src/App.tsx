  ...
  useEffect(() => {
    const pushTrayLabels = () => {
      const labels: TrayLabels = {
        ...
        updateAvailableTitle: t("tray.updateAvailableTitle"),
        updateAvailableMessage: t("tray.updateAvailableMessage"),
        upToDateTitle: t("tray.upToDateTitle"),
        upToDateMessage: t("tray.upToDateMessage"),
        updateCheckFailedTitle: t("tray.updateCheckFailedTitle"),
        updateCheckFailedMessage: t("tray.updateCheckFailedMessage"),
        openDownload: t("tray.openDownload"),
        later: t("tray.later"),
        quit: t("tray.quit"),
